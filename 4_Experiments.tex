...
\begin{figure}
    ...
    \makebox[\textwidth][c]
    {
        \includegraphics[width=1.7\linewidth]{figures/Expt_2/image_quality/image_quality_inspection_viz-2.png}
    }
...
The least-squares adversarial loss used in our CycleGAN models is shows in Equation \ref{eq:gan_loss}.
\begin{equation}
    \begin{aligned}
